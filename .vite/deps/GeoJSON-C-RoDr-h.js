import { n as abstract } from "./Object-DolGq2cf.js";
import { n as isEmpty } from "./obj-BGAAjjDC.js";
import { j as transformExtent, m as equivalent, x as getTransform, y as get } from "./proj-BM-4T99l.js";
import { D as getLayoutForStride, v as deflateCoordinatesArray, y as deflateMultiCoordinatesArray } from "./intersectsextent-Bqx-JGI7.js";
import { c as linearRingsAreOriented, d as orientLinearRingsArray, l as linearRingssAreOriented, m as Point, t as Polygon, u as orientLinearRings } from "./Polygon-BePo0SOh.js";
...
function transformExtentWithOptions(extent, options) {
	const featureProjection = options ? get(options.featureProjection) : null;
	const dataProjection = options ? get(options.dataProjection) : null;
	if (featureProjection && dataProjection && !equivalent(featureProjection, dataProjection)) return transformExtent(extent, dataProjection, featureProjection);
	return extent;
}
...
//#endregion
export { transformGeometryWithOptions as a, transformExtentWithOptions as i, JSONFeature as n, FeatureFormat as r, GeoJSON as t };

//# sourceMappingURL=GeoJSON-C-RoDr-h.js.map