import { b as EventType_default, f as ascending, h as equals, i as Observable, m as descending, n as abstract, r as getUid, v as reverseSubArray } from "./Object-DolGq2cf.js";
import { n as isEmpty } from "./obj-BGAAjjDC.js";
import { E as asArray, F as isCanvas, I as releaseCanvas, J as WORKER_OFFSCREEN_CANVAS, M as createCanvasContext2D, N as createMockDiv, P as getSharedCanvasContext2D, S as ImageState_default, _ as registerFont, a as defaultFillStyle, c as defaultLineDash, d as defaultStrokeStyle, f as defaultTextAlign, g as measureAndCacheTextWidth, h as getTextDimensions, l as defaultLineJoin, m as drawImageOrLabel, o as defaultFont, p as defaultTextBaseline, s as defaultLineCap, u as defaultPadding, v as asColorLike } from "./Circle-Cfa2pvvk.js";
import { m as ViewHint_default } from "./View-CNu_fp1q.js";
import { n as lerp, s as toFixed, t as clamp } from "./math-C8anmfUQ.js";
import { $ as coordinateRelationship, C as getUserProjection, J as clone, O as toUserExtent, S as getTransformFromProjections, Tt as Relationship_default, U as wrapX, X as containsCoordinate, Z as containsExtent, _ as fromUserExtent, _t as getTopRight, dt as getBottomRight, et as createEmpty, gt as getTopLeft, k as toUserResolution, mt as getHeight, q as buffer, st as extendCoordinate, tt as createOrUpdate, ut as getBottomLeft, vt as getWidth, wt as wrapX$1, xt as isEmpty$1, yt as intersects, z as angleBetween } from "./proj-BM-4T99l.js";
import { B as toString, F as create, I as equivalent, M as transform2D, N as apply, P as compose, R as makeInverse, f as snap, h as inflateMultiCoordinatesArray, j as rotate, k as transformGeom2D, m as inflateCoordinatesArray, p as inflateCoordinates, z as setFromArray } from "./intersectsextent-Bqx-JGI7.js";
import { a as EventType_default$1, n as BaseVectorLayer, t as RenderEvent } from "./Event-DXAR8nLt.js";
import { n as Icon } from "./Text-DOTJW4YE.js";
...
var CanvasVectorLayerRenderer = class extends CanvasLayerRenderer {
	...
	*/
	renderFrame(frameState, target) {
		...
		if (!render) {
			if (!(this.getLayer().hasListener(EventType_default$1.PRERENDER) || this.getLayer().hasListener(EventType_default$1.POSTRENDER))) return this.container;
		}
